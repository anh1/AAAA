...
Ext.ux.grid.CheckColumn = Ext.extend(Ext.grid.Column, {
	...
	if(this.name=="select") {
		...
		switch (selectedgrid)
		{
			...
			case "sbtnncode":
			if(record.data.select==true) {naicsg.push(record.data.sbtnncode); } else {naicsg.pop(record.data.sbtnncode); }
		        break;
		        case "sbtnccft":
			if(record.data.select==true) {clsg.push(record.data.sbtnccft); } else {clsg.pop(record.data.sbtnccft);}
		        break;
			case "abrev":
